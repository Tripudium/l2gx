...
@numba.njit
def fennel_clustering_no_progress(
    ...
    """
    FENNEL single-pass graph clustering algorithm without progress bars
    
    This is a version of the Fennel algorithm that avoids tqdm progress bars
    to prevent Numba compilation issues.
